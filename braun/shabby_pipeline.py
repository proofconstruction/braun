...
def get_pipeline():
    ...
    ink_phase = [
        OneOf(
            [
                Dithering(
                    dithering_dither_type,
                    dithering_order,
                    p=dithering_p,
                ),
                InkBleed(
                    inkbleed_intensity_range,
    ...
    post_phase = [
        ...
        OneOf(
            [
                LightingGradient(
                    lightinggradient_light_position,
        ...
        BindingsAndFasteners(
            bindingsandfasteners_overlay_types,
